...
def animate_best_routes(best_routes_per_generation, cities, cost_matrix, cities_coords):
    ...
    # for frame, (route, cost) in enumerate(unique_best_routes):
        ...
        route_colour = '#EB3324' # Color for the route
        ...
        html_path = f'output/frame_{frame}.html'
        map.save(html_path)
        # Append image path to list
        image_path = f'output/frame_{frame}.png'
    ...
    gif_path = f'output/best_route_evolution_{best_routes_per_generation[0][0][0]}_{best_routes_per_generation[0][0][-1]}.gif'
